...
//   }
   ...
   // MARK: - Goal CRUD
   func addGoal(name: String, action: String, frequency: GoalUnitTime, type: GoalType) {
      let newGoal = Goal(name: name, action: action, frequency: frequency, progress: [], type: type)
...
//    func recordProgress(for goalID: UUID, amount: Int) {
//        let newProgress = Progress(goalID: goalID, amount: amount, date: Date())
